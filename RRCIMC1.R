...
RRCIMC1= function(
title = "RRCIMC1", # Question-bank title that will be easily viewable in e-learning
...
quest.txt1 = "Both a new medication and placebo were administered to two separate groups of subjects. The subjects were monitored for recovery from an illness and the results were recorded in the 2x2 contingency table above. What is the 95% CI for the risk ratio given recovery in subjects who received the medication vs. those who received the placebo?", # The above text is the static text for the question
...
loc.path = "/Users/josephyang/Desktop/School Stuff/STAT 1600/Course Development/Question Generators/Stat1600-QGen/RRCIMC1 images/", # This is the local path used to store any randomly generated image files
...
feedback = "RR = a/(a+b)/(c/(c+d)). SE = sqrt(1/a + 1/c - 1/(a+b) - 1/(c+d)). ME for ln(RR) = 1.96*SE." # This is student feedback, visible after the exam
)
{
