##### BinomExactMC2 #####
BinomExactMC2= function(
title = "BinomExactMC2", # Question-bank title that will be easily viewable in e-learning
...
for(i in 1:n)
{
  ...
  data3 <- sample(1:7, size = 1) # randomy generating the number of successes needed for the question
  corr.ans <- round(dbinom(data3, data1, 1/data2), digits = digits) # this is the correct answer to the question based on the exact binomial formula
...
BinomExactMC2() # creating the csv file