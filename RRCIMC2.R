##### RRCIMC2 #####
RRCIMC2= function(
title = "RRCIMC2", # Question-bank title that will be easily viewable in e-learning
...
quest.txt2 = " for the risk ratio between the two samples. Which of the following statistical inferences should she make?", # The above 4 question texts are static texts for the full question
...
for(i in 1:n)
{
  ...
  else{"The risk ratio is significant at the 95% confidence level."} # this is the correct answer to the question depending on the conditions
