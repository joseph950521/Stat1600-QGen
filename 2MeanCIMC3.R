##### 2MeanCIMC3 #####
twomeanCIMC3= function(
title = "2MeanCIMC3", # Question-bank title that will be easily viewable in e-learning
...
quest.txt2 = " for the average difference. Which of the following statistical inferences should she make?", # The above 2 question texts are static texts for the full question
...
twomeanCIMC3() # creating the csv file