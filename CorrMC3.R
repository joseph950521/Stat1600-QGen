##### CorrMC3 #####
CorrMC3= function(
title = "CorrMC3", # Question-bank title that will be easily viewable in e-learning
...
quest.txt2 = ". Which of the correlations is the weakest?", # the above two texts are static text for the question
...
for(i in 1:n)
{
  ...
  corr.ans <- r[which.min(abs(r))] # This is the correct answer to the question
  ans.txt <- r[-which.min(abs(r))] # These are the incorrect answers
