...
ChisqMC1= function(
  title = "ChisqMC1", # Question-bank title that will be easily viewable in e-learning
  ...
  quest.txt2 = " cell?", # The above 2 question texts are static text for the full question
  digits = 2, # This is the number of decimal places to round off the data
  loc.path = "/Users/josephyang/Desktop/School Stuff/STAT 1600/Course Development/Question Generators/Stat1600-QGen/ChisqMC1 images/", # This is the local path used to store any randomly generated image files
  e.path = "Images/", # This is the path on e-learning used to store any above-implemented image files
  hint = "You need the formula for expected counts from your chapter on chi squares. Pick the closest answer.", # This is a student hint, visible to them during the exam on e-learning
  feedback = "row total * col total / grand total" # This is student feedback, visible after the exam
)
{
...
ChisqMC1() # creating the csv file
