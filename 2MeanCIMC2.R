##### 2MeanCIMC2 #####
twomeanCIMC2= function(
title = "2MeanCIMC2", # Question-bank title that will be easily viewable in e-learning
...
quest.txt2 = " for the difference between the two means. Which of the following statistical inferences should she make?", # The above 2 question texts are static texts for the full question
...
for(i in 1:n)
{
  ...
  else{"The difference between the true means is significant at the 95% confidence level."} # this is the correct answer to the question
...
twomeanCIMC2() # creating the csv file