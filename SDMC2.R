...
SDMC2= function(
  title = "SDMC2", # Question-bank title that will be easily viewable in e-learning
  ...
  quest.txt2 = " race times than Ian. To test their hypothesis, they monitor 50 consecutive races and record the above means and standard deviations of their race times (in minutes). Do these summary statistics confirm their hypothesis?", # The above 2 question texts are static text for the full question
  ...
  loc.path = "/Users/josephyang/Desktop/School Stuff/STAT 1600/Course Development/Question Generators/Stat1600-QGen/SDMC2 images/", # This is the local path used to store any randomly generated image files
...
)
{
  ...
  for(i in 1:n)
  {
    ...
    data1 <- sample(c("has more consistent (less variable)", "has less consistent (more variable)"), size = 1) # This is how we're randomly generating option choices for this question
