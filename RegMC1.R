...
RegMC1= function(
title = "RegMC1", # Question-bank title that will be easily viewable in e-learning
...
for(i in 1:n)
{
  ...
  data4 <- sample(c("slope", "intercept"), size = 1) # creating the option for question of interest 
